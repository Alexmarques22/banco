...
namespace Banco
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            conta2.nome = "Lucas"; conta2.saldo = 4000;
            // Console.WriteLine("O saldo anterior é: R$" + conta2.saldo);
            //if (conta2.sacar(1000))
            // Console.WriteLine("O saldo depois do saque é: " + conta2.sa
            ...
            Console.WriteLine("O VALOR DA TRANSFERENCIA FOI DE: " + conta2.valorTrasferencia);
        }
    }
}